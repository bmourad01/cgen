...
module Rules = struct
  ...
  let rules = Op.[
      ...
      (add `i8 x y =>? add `i8 y x) ~if_:(is_const "x");
      (add `i16 x y =>? add `i16 y x) ~if_:(is_const "x");
      (add `i32 x y =>? add `i32 y x) ~if_:(is_const "x");
      (add `i64 x y =>? add `i64 y x) ~if_:(is_const "x");
      (mul `i8 x y =>? mul `i8 y x) ~if_:(is_const "x");
      (mul `i16 x y =>? mul `i16 y x) ~if_:(is_const "x");
      (mul `i32 x y =>? mul `i32 y x) ~if_:(is_const "x");
      (mul `i64 x y =>? mul `i64 y x) ~if_:(is_const "x");
      (mulh `i8 x y =>? mulh `i8 y x) ~if_:(is_const "x");
      (mulh `i16 x y =>? mulh `i16 y x) ~if_:(is_const "x");
      (mulh `i32 x y =>? mulh `i32 y x) ~if_:(is_const "x");
      (mulh `i64 x y =>? mulh `i64 y x) ~if_:(is_const "x");
      (and_ `i8 x y =>? and_ `i8 y x) ~if_:(is_const "x");
      (and_ `i16 x y =>? and_ `i16 y x) ~if_:(is_const "x");
      (and_ `i32 x y =>? and_ `i32 y x) ~if_:(is_const "x");
      (and_ `i64 x y =>? and_ `i64 y x) ~if_:(is_const "x");
      (or_ `i8 x y =>? or_ `i8 y x) ~if_:(is_const "x");
      (or_ `i16 x y =>? or_ `i16 y x) ~if_:(is_const "x");
      (or_ `i32 x y =>? or_ `i32 y x) ~if_:(is_const "x");
      (or_ `i64 x y =>? or_ `i64 y x) ~if_:(is_const "x");
      (xor `i8 x y =>? xor `i8 y x) ~if_:(is_const "x");
      (xor `i16 x y =>? xor `i16 y x) ~if_:(is_const "x");
      (xor `i32 x y =>? xor `i32 y x) ~if_:(is_const "x");
      (xor `i64 x y =>? xor `i64 y x) ~if_:(is_const "x");
      (eq `i8 x y =>? eq `i8 y x) ~if_:(is_const "x");
      (eq `i16 x y =>? eq `i16 y x) ~if_:(is_const "x");
      (eq `i32 x y =>? eq `i32 y x) ~if_:(is_const "x");
      (eq `i64 x y =>? eq `i64 y x) ~if_:(is_const "x");
      (ne `i8 x y =>? ne `i8 y x) ~if_:(is_const "x");
      (ne `i16 x y =>? ne `i16 y x) ~if_:(is_const "x");
      (ne `i32 x y =>? ne `i32 y x) ~if_:(is_const "x");
      (ne `i64 x y =>? ne `i64 y x) ~if_:(is_const "x");
      (gt `i8 x y =>? lt `i8 y x) ~if_:(is_const "x");
      (gt `i16 x y =>? lt `i16 y x) ~if_:(is_const "x");
      (gt `i32 x y =>? lt `i32 y x) ~if_:(is_const "x");
      (gt `i64 x y =>? lt `i64 y x) ~if_:(is_const "x");
      (ge `i8 x y =>? le `i8 y x) ~if_:(is_const "x");
      (ge `i16 x y =>? le `i16 y x) ~if_:(is_const "x");
      (ge `i32 x y =>? le `i32 y x) ~if_:(is_const "x");
      (ge `i64 x y =>? le `i64 y x) ~if_:(is_const "x");
      (le `i8 x y =>? ge `i8 y x) ~if_:(is_const "x");
      (le `i16 x y =>? ge `i16 y x) ~if_:(is_const "x");
      (le `i32 x y =>? ge `i32 y x) ~if_:(is_const "x");
      (le `i64 x y =>? ge `i64 y x) ~if_:(is_const "x");
      (lt `i8 x y =>? gt `i8 y x) ~if_:(is_const "x");
      (lt `i16 x y =>? gt `i16 y x) ~if_:(is_const "x");
      (lt `i32 x y =>? gt `i32 y x) ~if_:(is_const "x");
      (lt `i64 x y =>? gt `i64 y x) ~if_:(is_const "x");
      (sgt `i8 x y =>? slt `i8 y x) ~if_:(is_const "x");
      (sgt `i16 x y =>? slt `i16 y x) ~if_:(is_const "x");
      (sgt `i32 x y =>? slt `i32 y x) ~if_:(is_const "x");
      (sgt `i64 x y =>? slt `i64 y x) ~if_:(is_const "x");
      (sge `i8 x y =>? sle `i8 y x) ~if_:(is_const "x");
      (sge `i16 x y =>? sle `i16 y x) ~if_:(is_const "x");
      (sge `i32 x y =>? sle `i32 y x) ~if_:(is_const "x");
      (sge `i64 x y =>? sle `i64 y x) ~if_:(is_const "x");
      (sle `i8 x y =>? sge `i8 y x) ~if_:(is_const "x");
      (sle `i16 x y =>? sge `i16 y x) ~if_:(is_const "x");
      (sle `i32 x y =>? sge `i32 y x) ~if_:(is_const "x");
      (sle `i64 x y =>? sge `i64 y x) ~if_:(is_const "x");
      (slt `i8 x y =>? sgt `i8 y x) ~if_:(is_const "x");
      (slt `i16 x y =>? sgt `i16 y x) ~if_:(is_const "x");
      (slt `i32 x y =>? sgt `i32 y x) ~if_:(is_const "x");
      (slt `i64 x y =>? sgt `i64 y x) ~if_:(is_const "x");
      (* Enable constant folding via associativity. *)
      (add `i8 (add `i8 x y) z =>? add `i8 x (add `i8 z y)) ~if_:(is_const "y");
      (add `i16 (add `i16 x y) z =>? add `i16 x (add `i16 z y)) ~if_:(is_const "y");
      (add `i32 (add `i32 x y) z =>? add `i32 x (add `i32 z y)) ~if_:(is_const "y");
      (add `i64 (add `i64 x y) z =>? add `i64 x (add `i64 z y)) ~if_:(is_const "y");
      (mul `i8 (mul `i8 x y) z =>? mul `i8 x (mul `i8 z y)) ~if_:(is_const "y");
      (mul `i16 (mul `i16 x y) z =>? mul `i16 x (mul `i16 z y)) ~if_:(is_const "y");
      (mul `i32 (mul `i32 x y) z =>? mul `i32 x (mul `i32 z y)) ~if_:(is_const "y");
      (mul `i64 (mul `i64 x y) z =>? mul `i64 x (mul `i64 z y)) ~if_:(is_const "y");
      (and_ `i8 (and_ `i8 x y) z =>? and_ `i8 x (and_ `i8 z y)) ~if_:(is_const "y");
      (and_ `i16 (and_ `i16 x y) z =>? and_ `i16 x (and_ `i16 z y)) ~if_:(is_const "y");
      (and_ `i32 (and_ `i32 x y) z =>? and_ `i32 x (and_ `i32 z y)) ~if_:(is_const "y");
      (and_ `i64 (and_ `i64 x y) z =>? and_ `i64 x (and_ `i64 z y)) ~if_:(is_const "y");
      (or_ `i8 (or_ `i8 x y) z =>? or_ `i8 x (or_ `i8 z y)) ~if_:(is_const "y");
      (or_ `i16 (or_ `i16 x y) z =>? or_ `i16 x (or_ `i16 z y)) ~if_:(is_const "y");
      (or_ `i32 (or_ `i32 x y) z =>? or_ `i32 x (or_ `i32 z y)) ~if_:(is_const "y");
      (or_ `i64 (or_ `i64 x y) z =>? or_ `i64 x (or_ `i64 z y)) ~if_:(is_const "y");
      (xor `i8 (xor `i8 x y) z =>? xor `i8 x (xor `i8 z y)) ~if_:(is_const "y");
      (xor `i16 (xor `i16 x y) z =>? xor `i16 x (xor `i16 z y)) ~if_:(is_const "y");
      (xor `i32 (xor `i32 x y) z =>? xor `i32 x (xor `i32 z y)) ~if_:(is_const "y");
      (xor `i64 (xor `i64 x y) z =>? xor `i64 x (xor `i64 z y)) ~if_:(is_const "y");
      (sub `i8 (sub `i8 x y) z =>? sub `i8 x (add `i8 z y)) ~if_:(is_const "y");
      (sub `i16 (sub `i16 x y) z =>? sub `i16 x (add `i16 z y)) ~if_:(is_const "y");
      (sub `i32 (sub `i32 x y) z =>? sub `i32 x (add `i32 z y)) ~if_:(is_const "y");
      (sub `i64 (sub `i64 x y) z =>? sub `i64 x (add `i64 z y)) ~if_:(is_const "y");
      (sub `i8 (sub `i8 x y) z =>? sub `i8 (sub `i8 x z) y) ~if_:(is_const "x");
      (sub `i16 (sub `i16 x y) z =>? sub `i16 (sub `i16 x z) y) ~if_:(is_const "x");
      (sub `i32 (sub `i32 x y) z =>? sub `i32 (sub `i32 x z) y) ~if_:(is_const "x");
      (sub `i64 (sub `i64 x y) z =>? sub `i64 (sub `i64 x z) y) ~if_:(is_const "x");
      (sub `i8 (add `i8 x y) z =>? sub `i8 x (sub `i8 z y)) ~if_:(is_const "y");
      (sub `i16 (add `i16 x y) z =>? sub `i16 x (sub `i16 z y)) ~if_:(is_const "y");
      (sub `i32 (add `i32 x y) z =>? sub `i32 x (sub `i32 z y)) ~if_:(is_const "y");
      (sub `i64 (add `i64 x y) z =>? sub `i64 x (sub `i64 z y)) ~if_:(is_const "y");
      (add `i8 (sub `i8 x y) z =>? add `i8 x (sub `i8 z y)) ~if_:(is_const "y");
      (add `i16 (sub `i16 x y) z =>? add `i16 x (sub `i16 z y)) ~if_:(is_const "y");
      (add `i32 (sub `i32 x y) z =>? add `i32 x (sub `i32 z y)) ~if_:(is_const "y");
      (add `i64 (sub `i64 x y) z =>? add `i64 x (sub `i64 z y)) ~if_:(is_const "y");
      (add `i8 (sub `i8 x y) z =>? sub `i8 (add `i8 x z) y) ~if_:(is_const "x");
      (add `i16 (sub `i16 x y) z =>? sub `i16 (add `i16 x z) y) ~if_:(is_const "x");
      (add `i32 (sub `i32 x y) z =>? sub `i32 (add `i32 x z) y) ~if_:(is_const "x");
      (add `i64 (sub `i64 x y) z =>? sub `i64 (add `i64 x z) y) ~if_:(is_const "x");
      (* x + 0 = x. *)
      add `i8 x  (i8 0) => x;
      add `i16 x (i16 0) => x;
      add `i32 x (i32 0l) => x;
