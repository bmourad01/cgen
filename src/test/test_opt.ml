...
let regalloc_suite = "Test register allocation" >::: [
    ...
    "Wfreeze priority: nested loop phi protection (SysV AMD64)" >:: test_sysv_amd64_regalloc "freeze_priority";
...
let native_suite = "Test native code" >::: [
    ...
    "Signed divide by 11 (SysV AMD64)" >:: test_sysv_amd64_native "sdivby11";
    "Signed divide by -1 (SysV AMD64)" >:: test_sysv_amd64_native "sdivbyn1";
    "Signed divide by -5 (SysV AMD64)" >:: test_sysv_amd64_native "sdivbyn5";
    "Signed remainder by 2 (SysV AMD64)" >:: test_sysv_amd64_native "sremby2";
    "Signed remainder by 7 (SysV AMD64)" >:: test_sysv_amd64_native "sremby7";
    "Signed remainder by 8 (SysV AMD64)" >:: test_sysv_amd64_native "sremby8";
    "Signed remainder by -1 (SysV AMD64)" >:: test_sysv_amd64_native "srembyn1";
    "Unsigned divide by 8 (SysV AMD64)" >:: test_sysv_amd64_native "udivby8";
    "Unsigned divide by 11 (SysV AMD64)" >:: test_sysv_amd64_native "udivby11";
